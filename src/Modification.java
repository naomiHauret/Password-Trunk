/******************************************************************************************************
 * <i>[FR]</i>
 * Classe <b>Modification</b>
 * 		<p>Boîte de dialogue permettant à l'utilisateur de modifier un mot de passe.</p>
  ******************************************************************************************************
 * <i>[EN]</i>
 * Class <b>Modification</b>
 * 		<p>Dialog window that allows the user to edit a password.</p>
  ******************************************************************************************************
 * @author Naomi Hauret
 * @version 1.0
 *******************************************************************************************************/
...
public class Modification extends JDialog{
	...
	public Modification(){
		...
		this.setTitle("Modifier un mot de passe...");
	...
	public void construireFenetre(){
		...
		this.button_modifier= new JButton("Modifier");
	...
	public class Clic implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource()==button_modifier){
				Principale.demandeModification(textField_site.getText(), textField_id.getText(), textField_mdp.getText(), indexModification);
				dispose();
			}
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void activeModification(boolean b){
		this.button_modifier.setEnabled(b);
	}
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void setSite(String s){
		this.textField_site.setText(s);
	}
	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void setId(String s){
		this.textField_id.setText(s);
	}
	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void setMdp(String s){
		this.textField_mdp.setText(s);
	}
	
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void setTextFields(String site, String id, String mdp){
		this.setSite(site);
		this.setId(id);
		this.setMdp(mdp);
	}
